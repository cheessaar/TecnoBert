      ...
      >
        ...
        <div className="space-y-4 mb-4 text-left">
          <p className="text-gray-700">
            Gracias por tu compra. Estamos procesando tu pedido y
            lo enviaremos pronto. Un correo de confirmación con los detalles de tu pedido será enviado a tu bandeja de entrada en breve.
          </p>
          <p className="text-gray-700">
            Número de Pedido:{" "}
