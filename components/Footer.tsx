      ...
      <Container>
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Logo />
            <SubText>
              Descubre colecciones de muebles curadas en TecnoBert, combinando
          ...
          <div className="space-y-4">
            ...
            <form className="space-y-3">
              <Input placeholder="Introduce tu correo electrónico" type="email" required />
        ...
        <div className="py-6 border-t text-center text-sm text-gray-600">
          <div>
            © {new Date().getFullYear()} <Logo className="text-sm" />. Todos los derechos reservados.
          </div>
        </div>
      </Container>
    </footer>
